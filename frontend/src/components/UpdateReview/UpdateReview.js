...
import '../WriteReview/WriteReview.css';
...
//   console.log(userReview )
  ...
  return (
      <div className='ReviewForm'>
          <h1 className='ReviewFormTitle'>Update a Review</h1>
          <br></br>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label className='ReviewFormTextarea'>
            <textarea
              ...
              maxLength="1300"
              minLength="100"
              placeholder="Update a Review"
            />
          </label>
          <button type="submit" className='ReviewFormSubmit'>Update Review</button>
        </form>
      </div>
    </div>
  );
